...
class ScanHistoryService:
    ...
    def update_scan_success(
        ...
        scan_record.total_listings_found = stats.get('listings_searched', 0)  # Changed to listings_searched
        scan_record.new_listings_added = stats.get('new_listings_added', 0)  # Now using correct key
    ...
    def get_scan_stats_summary(cls) -> Dict[str, Any]:
        ...
        # Serialize the latest scan to avoid JSON serialization issues
